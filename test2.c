...
int main() {
    ...
    _Bool test1Passed = performUnitTest(board1, 1);
    ...
    _Bool test2Passed = performUnitTest(board2, 1);
    ...
    _Bool test3Passed = performUnitTest(board3, 1);
    ...
    _Bool test4Passed = performUnitTest(board4, 0);
